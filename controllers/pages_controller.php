  ...
  class PagesController {
    public function home() {
      if(!isset($_SESSION['id'])){
        ...
        $aantalSnippets = count(Snippet::all(false,"","","",false));
      ...
      if(isset($_POST['submit'])){
        ...
        if(!empty($_POST['telefoonnummer'])){
          ...
          if($gelukt){
            ...
            $registered = User::Register($genId, $post_gebruikersnaam, $post_voornaam, $post_achternaam, $wachtwoord, $salt, $post_email, $post_telefoonnummer, 3);
          }
      }
